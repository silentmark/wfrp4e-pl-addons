...
export default class CircleHelper {
    ...
    static getProgressCircleHtml(data) {
        return `<svg style="position: absolute; top: -8px; left: -8px;" class="progress-ring progress-ring--${data.class}" viewBox="0 0 ${data.diameter} ${data.diameter}" width="${data.diameter}" height="${data.diameter}">
        <circle
