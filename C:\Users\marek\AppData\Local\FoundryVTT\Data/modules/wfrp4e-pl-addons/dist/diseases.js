...
class Diseases {
  ...
  setup() {
    if (game.settings.get('wfrp4e-pl-addons', 'customDiseases.Enable')) {
      ...
      Hooks.on('ready', () => {
        const { symptoms } = game.wfrp4e.config;
        ...
        const symptomsDesc = game.wfrp4e.config.symptomDescriptions;
        ...
        const symptomsTreat = game.wfrp4e.config.symptomTreatment;
